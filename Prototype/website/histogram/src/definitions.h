...
typedef CGAL::Triangulation_vertex_base_with_info_2<double, K>    Vb1;
typedef CGAL::Triangulation_data_structure_2<Vb1>                       Tds1;
typedef CGAL::Delaunay_triangulation_2<K, Tds1>                         Delaunay;
...
typedef CGAL::Random_points_in_square_2<Point2,CGAL::Creator_uniform_2< double, Point2>> Point_generator_square;
#include <CGAL/point_generators_3.h>
#include <random>
...
typedef VD::Face_iterator             FaceIterator;
typedef VD::Halfedge_around_vertex_circulator Halfedge_around_vertex_circulator;

typedef DT::Vertex_handle   vertex_handle_2;
typedef DT::Vertex_circulator vertex_circulator_2;
